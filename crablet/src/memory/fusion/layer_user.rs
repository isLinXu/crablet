...
pub use super::layer_user_types::{
    CommunicationStyle, DetailLevel, GoalStatus, Memory, MemoryType, Preference,
    PreferenceValue, ProfileMetadata, UserCommunication, UserConfig, UserFact, UserGoal,
    UserProfileData,
};
